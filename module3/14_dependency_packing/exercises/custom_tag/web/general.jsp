...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-md-6" >
                    <h2>Manage <b>${tblName}</b></h2>
                </div>
                <div class="col-md-6">
                    <a class="btn btn-success add" data-toggle="modal"><i class="material-icons">&#xE147;</i>
                        <span>Add New ${tblName}</span></a>
                </div>
            </div>
        </div>
        <div>
            <form action="/general?action=search" method="post">

                Search by
                <select name="by">
                    <c:forEach var="item" items="${columns}"><option>${item}</option></c:forEach>
                </select>
                <input name="value">
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog">
        <form method="post" action="/general?action=delete">
            <div class="modal-content">
                <div class="modal-header">
