...
import service.file.NoteTypeFile;
import service.file.NoteTypeFileImpl;
...
public class NoteTypeServlet extends HttpServlet {
    ...
    //NoteTypeFile noteTypeFile= new NoteTypeFileImpl();
    NoteTypeManager notetypes= new NoteTypeManagerImpl(noteTypeDAO);
        ...
        switch (action) {
            case "search":
                ...
                if(!searchVal.isEmpty()){
                    ...
                    request.setAttribute("notetypes",res);
