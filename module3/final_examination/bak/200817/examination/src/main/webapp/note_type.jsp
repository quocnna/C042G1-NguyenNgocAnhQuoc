        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach var="item" items="${res}">
                <tr>
                    ...
                    <td>
                        <a href="#viewModal" class="view" data-toggle="modal" data-name="${item.name}"
                           data-description="${item.description}"><i class="material-icons">&#xE417;</i></a>
                        <a href="#addEditModal" class="edit" data-toggle="modal" data-id="${item.id}" data-name="${item.name}"
                           data-description="${item.description}"><i class="material-icons">&#xE254;</i></a>
                        <a href="#deleteModal" class="delete" data-toggle="modal" data-id="${item.id}"><i class="material-icons">&#xE872;</i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
    ...
    <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">View Note Type</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label style="color: blue;padding-left: 5px" class="viewDescription">description</label>
                    </div>
                </div>
...
<div id="addEditModal" class="modal fade">
    <div class="modal-dialog">
        <form id="fAddEdit" method="post" action="/note_type">
            <div class="modal-content">
                <div class="modal-header">
            ...
            message: 'This value is not valid', fields:
                {
                    ...
                    description: {
                        validators: {
                            ...
                            emailAddress: {
                                message: 'The Description is not a valid email address'
                            }
                        }
                    }
                }
