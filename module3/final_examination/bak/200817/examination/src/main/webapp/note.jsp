        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach var="item" items="${res}">
                <tr>
                    ...
                    <td>
                        <a href="#viewModal" class="view" data-toggle="modal"  data-title="${item.title}"
                           data-content="${item.content}" data-note_type_name="${item.note_type_name}"><i class="material-icons">&#xE417;</i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Title:</label>
                    <label style="color: blue;padding-left: 5px" class="viewTitle">title</label>
                </div>
                <div class="form-group">
                    <label>Content:</label>
                    <label style="color: blue;padding-left: 5px" class="viewContent">content</label>
                </div>
                <div class="form-group">
                    <label>Note Type Name:</label>
                    <label style="color: blue;padding-left: 5px" class="viewNoteTypeName">note type name</label>
                </div>
            </div>
...
<div id="addEditModal" class="modal fade">
    <div class="modal-dialog">
        <form id="fAddEdit" method="post" action="/note">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    ...
    $(".view").click(function () {
        ...
        $("label[class='viewNoteTypeName']").text($(this).data("note_type_name"));
    });
