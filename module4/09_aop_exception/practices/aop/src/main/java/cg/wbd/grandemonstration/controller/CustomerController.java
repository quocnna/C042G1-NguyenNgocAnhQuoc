...
import cg.wbd.grandemonstration.exception.MyException;
...
public class CustomerController {
    ...
    @GetMapping("{id}")
    public ModelAndView showInformation(@PathVariable Long id) throws MyException {
    ...
    public String showInputNotAcceptable() {
        return"customers/inputs-not-acceptable";
    }
}
